...
Rectangle {
    ...
    Timer{
        ...
        onTriggered:{
            ...
            if(shaderEffect.checkDistance2(shaderEffect.obstacle1,ballItem2,obstacleSize,ballSize/2)
                    ||shaderEffect.checkDistance2(shaderEffect.obstacle2,ballItem2,obstacleSize,ballSize/2))
            {
    ...
    Ball {
        ...
        SequentialAnimation on x{
            ...
            NumberAnimation { to: shader1Container.width; duration: 600; easing.type: Easing.Linear }
    ...
    ShaderEffect {
        ...
        property alias obstacleSize: shader1Container.obstacleSize
